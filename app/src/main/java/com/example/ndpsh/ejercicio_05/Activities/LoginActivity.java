package com.example.ndpsh.ejercicio_05.Activities;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoggy.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void bindUI() {
        ...
        btnLoggy = findViewById(R.id.buttonLoggy);
    }
